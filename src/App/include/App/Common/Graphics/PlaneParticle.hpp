...
class PlaneParticle : public ParticleBase<PlaneParticleOption, 256> {
public:
...
protected:
    void batch(std::array<VertexParticle3D, 256>& particles, const ParticleParameter<PlaneParticleOption>& params) override
    {
        Random random;
