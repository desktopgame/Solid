...
class PlaneParticle : public ParticleBase<PlaneParticleOption> {
public:
...
protected:
    void batch(std::array<VertexParticle3D, NumParticles>& particles, const ParticleParameter<PlaneParticleOption>& params) override
    {
        Random random;
