...
void TitleScene::onEnter()
{
    ...
    if (!m_baseUI) {
        ...
        m_baseUI->addLayoutElement(std::make_shared<LayoutElement>(createHelpPanel(), std::make_shared<BorderLayout::Hint>("BOTTOM")));
...
std::shared_ptr<Panel> TitleScene::createHelpPanel()
{
