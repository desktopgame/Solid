...
public:
    ...
    static std::shared_ptr<CpuBuffer> create(Type type);
    ~CpuBuffer();
    ...
    void transport(const Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& cmdList, const std::shared_ptr<CpuBuffer>& dst);
